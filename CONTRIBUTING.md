...
После объединения музыкальной ветки и обновлений Markdev используйте [инструкцию обновления существующей базы](COMBINED_UPDATES.md). Одинаковые числовые префиксы миграций из разных веток не означают, что это один файл.
